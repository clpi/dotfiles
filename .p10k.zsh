# Generated by Powerlevel10k configuration wizard on 2020-11-09 at 00:18 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_PATH_HIGHLIGHT_FOREGROUND=120
  ...
  #typeset -g POWERLEVEL9K_HOME_FOLDER_ABBREVIATION="%F{color1210} $(print_icon 'HOME_ICON') %F{color233}"
  ...
  function my_git_formatter() {
    ...
    local       meta='%120F' # green foreground
    local      clean='%122F' # cyan foreground
    local   modified='%215F' # yell foreground
    local  untracked='%141F' # purp foreground
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=120
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=215
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=215
  ...
  typeset -g POWERLEVEL9K_ASDF_RUST_FOREGROUND=228
  typeset -g POWERLEVEL9K_ASDF_RUST_BACKGROUND=236
  ...
  typeset -g POWERLEVEL9K_ASDF_FLUTTER_FOREGROUND=8
  typeset -g POWERLEVEL9K_ASDF_FLUTTER_BACKGROUND=122
  ...
  #################[ ranger: ranger shell (https://github.com/ranger/ranger) ]##################
  # Ranger shell color.
  typeset -g POWERLEVEL9K_RANGER_FOREGROUND=236
  typeset -g POWERLEVEL9K_RANGER_BACKGROUND=159
  # Custom icon.
  ...
  ###########[ timewarrior: timewarrior tracking status (https://timewarrior.net/) ]############
  # Timewarrior color.
  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND=122
  typeset -g POWERLEVEL9K_TIMEWARRIOR_BACKGROUND=238

  # If the tracked task is longer than 24 characters, truncate and append "…".
  # Tip: To always display tasks without truncation, delete the following parameter.
  # Tip: To hide task names and display just the icon when time tracking is enabled, set the
  # value of the following parameter to "".
  typeset -g POWERLEVEL9K_TIMEWARRIOR_CONTENT_EXPANSION='${P9K_CONTENT:0:10}${${P9K_CONTENT:10}:+…}'
  ...
  ##############[ taskwarrior: taskwarrior task count (https://taskwarrior.org/) ]##############
  # Taskwarrior color.
  typeset -g POWERLEVEL9K_TASKWARRIOR_FOREGROUND=120
  typeset -g POWERLEVEL9K_TASKWARRIOR_BACKGROUND=236
  ...
  #################[ rust_version: rustc version (https://www.rust-lang.org) ]##################
  # Rust version color.
  typeset -g POWERLEVEL9K_RUST_VERSION_FOREGROUND=215
  typeset -g POWERLEVEL9K_RUST_VERSION_BACKGROUND=236
  ...
  typeset -g POWERLEVEL9K_BATTERY_STAGES=('%K{242}▁' '%K{242}▂' '%K{242}▃' '%K{242}▄' '%K{242}▅' '%K{242}▆' '%K{242}▇' '%K{242}█')
