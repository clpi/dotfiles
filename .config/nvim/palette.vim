...
" flat colors:
let s:asphalt = { "gui": "#1e1c31", "cterm": "233", "cterm16": "0"}
let s:asphalt_subtle= { "gui": "#15132a", "cterm": "232", "cterm16": "0"}
let s:asphalt_subtle_darker= { "gui": "#151329", "cterm": "232", "cterm16": "0"}
let s:addd = { "gui": "#141329", "cterm": "232", "cterm16": "0"}
" let s:asphalt_subtle_more = { "gui": "#302E43", "cterm": "232", "cterm16": "0"}
let s:asphalt_subtle_more = { "gui": "#272040", "cterm": "232", "cterm16": "0"}
let s:asphalt_subtle_more_more = { "gui": "#373052", "cterm": "232", "cterm16": "0"}
let s:dark_asphalt = { "gui": "#565575", "cterm": "236", "cterm16": "8"}

let s:red = { "gui": "#ff8080", "cterm": "204", "cterm16": "1"}
let s:dark_red = { "gui": "#ff6363", "cterm": "203", "cterm16": "9"}

let s:green = { "gui": "#91ffaa", "cterm": "120", "cterm16": "2"}
let s:dark_green = { "gui": "#63dd91", "cterm": "119", "cterm16": "10"}
...
let s:dark_blue = { "gui": "#63b3ff", "cterm": "75", "cterm16": "12"}

let s:purple = { "gui": "#dd91ff", "cterm": "141", "cterm16": "5"}
let s:dark_purple = { "gui": "#aa80ff", "cterm": "135", "cterm16": "13"}

let s:cyan = { "gui": "#aaffe9", "cterm": "122", "cterm16": "6"}
let s:dark_cyan = { "gui": "#63eeee", "cterm": "121", "cterm16": "14"}
...
let s:bg_subtle_more  = s:asphalt_subtle_darker
let s:bg_dark         = s:dark_asphalt
let s:bg_darker       = s:asphalt_subtle_darker
let s:norm            = s:clouds
let s:norm_subtle     = s:dark_clouds
let s:visual          = s:asphalt_subtle_more_more
...
call s:h("StatusLineNC",  {"bg": s:bg_subtle, "fg": s:medium_gray})
call s:h("VertSplit",     {"fg": s:bg_subtle})
call s:h("Title",         {"fg": s:dark_blue})
call s:h("Visual",        {"bg": s:visual})
call s:h("WarningMsg",    {"fg": s:dark_yellow})
call s:h("WildMenu",      {"fg": s:bg_subtle, "bg": s:cyan})
call s:h("Folded",        {"bg": s:purple, "fg": s:bg_subtle})
call s:h("FoldColumn",    {"fg": s:yellow, "bg": s:addd})
call s:h("DiffAdd",       {"fg": s:green, "bg": s:addd})
call s:h("DiffDelete",    {"fg": s:red, "bg": s:addd})
call s:h("DiffChange",    {"fg": s:dark_yellow, "bg": s:addd})
call s:h("DiffText",      {"fg": s:dark_blue, "bg": s:addd})
call s:h("SignColumn",    {"fg": s:green, "bg": s:addd})
...
call s:h("MsgArea",       {"fg": s:norm, "bg": s:bg_subtle})
call s:h("Pmenu",         {"fg": s:norm, "bg": s:bg_subtle})
call s:h("PmenuSel",      {"fg": s:bg_subtle, "bg": s:green})
call s:h("PmenuSbar",     {"fg": s:norm, "bg": s:bg_darker})
call s:h("PmenuThumb",    {"fg": s:green, "bg": s:asphalt_subtle_more})
call s:h("TabLine",       {"fg": s:dark_asphalt, "bg": s:asphalt_subtle_darker})
call s:h("TabLineSel",    {"fg": s:bg, "bg": s:green})
" call s:h("TabLineSel",    {"fg": s:green, "bg": s:bg_dark})
" call s:h("TabLineFill",   {"fg": s:green, "bg": s:bg_darker})
call s:h("TabLineFill",   {"fg": s:norm, "bg": s:bg_subtle})
call s:h("CursorColumn",  {"bg": s:bg_subtle})
call s:h("CursorLine",    {"bg": s:bg_subtle_more})
