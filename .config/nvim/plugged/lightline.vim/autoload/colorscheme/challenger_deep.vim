...
let s:purple = { "gui": "#d99fff", "cterm": "141", "cterm16": "5"}
...
let s:p.command.middle   = [ [ s:lfc.red, s:lfc.bg_subtle ], [s:lfc.dark_asphalt, s:lfc.bg_subtle] ]
let s:p.command.right    = [ [ s:lfc.red, s:lfc.red ],  [ s:lfc.red, s:lfc.asphalt_subtle_more ] ]

let s:p.terminal.left     = [ [ s:lfc.bg_subtle, s:lfc.blue ],  [ s:lfc.blue, s:lfc.asphalt_subtle_more ], [ s:lfc.dark_asphalt, s:lfc.bg_subtle  ]]
let s:p.terminal.middle   = [ [ s:lfc.blue, s:lfc.bg_subtle ], [s:lfc.dark_asphalt, s:lfc.bg_subtle] ]
let s:p.terminal.right    = [ [ s:lfc.blue, s:lfc.blue ],  [ s:lfc.blue, s:lfc.asphalt_subtle_more ] ]
