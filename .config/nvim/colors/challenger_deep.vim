...
let s:purple = { "gui": "#e99fff", "cterm": "141", "cterm16": "5"}
...
call s:h("CursorLineNr",  {"bg": s:bg_subtle_more, "fg": s:green, "gui": "bold"})
...
call s:h("TabLine",       {"fg": s:medium_gray, "bg": s:asphalt_subtle})
call s:h("TabLineSel",    {"fg": s:bg_subtle_more, "bg": s:green})
" call s:h("TabLineSel",    {"fg": s:green, "bg": s:bg_dark})
" call s:h("TabLineFill",   {"fg": s:green, "bg": s:bg_darker})
call s:h("TabLineFill",   {"fg": s:norm, "bg": s:bg_darker})
